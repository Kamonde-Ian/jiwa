            ...
            <div class="accordion" id="faqAccordion">
                @php
                    $faqs = [
                        ...
                        ['q' => 'What is the daily interest rate?', 'a' => 'Plans earn a fixed daily rate of 0.5% on your invested amount, credited automatically to your earnings wallet every 24 hours. Rates are admin-configurable.'],
                        ...
                        ['q' => 'What are the minimums and durations?', 'a' => 'The minimum investment is $'.number_format((float) config('jiwa.min_investment'), 2).'. Investment durations range from 30, 90, 180, 365, to 730 days, plus configurable custom plans.'],
